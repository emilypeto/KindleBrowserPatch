...
Method:
1. Download the [latest release](https://github.com/emilypeto/KindleBrowserPatch/releases/download/v2.0.1/kindle_browser_patch-2.0.1-armhf.zip), plug in your Kindle and extract it to the `extensions` folder in the root of the mounted storage, such that you now have a folder at `extensions/kindle_browser_patch`. It must be named exactly this or it won't install.
